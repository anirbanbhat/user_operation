...
PASSWORD_VALIDATION_ERR = 'Password should 8 to 25 characters and it should contain at least one upper case ' \
                          'letter, one lower case letter, one digit and one special characters (@$#_); '
